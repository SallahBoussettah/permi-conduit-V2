                ...
                <div class="md:flex md:items-center">
                    ...
                    <div class="md:w-1/3 flex justify-center p-8">
                        <div class="bg-yellow-500 rounded-full p-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-gray-900" fill="none"
                                    ...
                                    <div class="p-6">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-5">
                                                ...
                                                <p class="mt-1 text-sm text-gray-500">
                                                    {{ __('Mettre à jour vos informations personnelles.') }}
                                                </p>
                                            </div>
                                        </div>
                                        <div class="mt-6">
                                    ...
                                    <div class="p-6">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-5">
                                                ...
                                                <p class="mt-1 text-sm text-gray-500">
                                                    {{ __('Répondre aux questions des candidats.') }}
                                                </p>
                                            </div>
                                        </div>
                                        <div class="mt-6">

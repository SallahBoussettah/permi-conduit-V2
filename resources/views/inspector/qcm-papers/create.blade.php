    ...
    <div class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center">
                ...
                <h1 class="text-3xl font-bold text-gray-900">{{ __('Créer un questionnaire QCM') }}</h1>
            </div>
            <p class="mt-2 text-sm text-gray-700">{{ __('Créer un nouveau questionnaire QCM pour votre catégorie de permis.') }}</p>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (form) {
        ...
        console.error('Aucun formulaire QCM trouvé');
    }
});
</script>
@endsection 
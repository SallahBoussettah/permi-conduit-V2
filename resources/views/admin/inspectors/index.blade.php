                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end space-x-3">
                                            <a href="{{ route('admin.inspectors.edit', $inspector->id) }}" class="text-indigo-600 hover:text-indigo-900" title="{{ __('Modifier') }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                </svg>
                                            </a>
                                            <form action="{{ route('admin.inspectors.toggle-active', $inspector->id) }}" method="POST" class="inline">
                                                @csrf
                                                <button type="submit" class="{{ $inspector->is_active ? 'text-red-600 hover:text-red-900' : 'text-green-600 hover:text-green-900' }}" title="{{ $inspector->is_active ? __('Désactiver') : __('Activer') }}">
                                                    @if($inspector->is_active)
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            <form action="{{ route('admin.inspectors.delete', $inspector->id) }}" method="POST" class="inline" onsubmit="return confirm('{{ __('Êtes-vous sûr de vouloir supprimer cet inspecteur ?') }}');">
                                                @csrf
                                                @method('DELETE')
